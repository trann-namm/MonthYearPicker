...
class MonthPickerView extends FrameLayout {
    ...
    int _monthNamesArrayResId = -1;
    //TODO
    String _titleMonthFormat = "MMM";
    Locale _locale;
    int _monthSelectedCircleSize = 43;
    ...
    */
        ...
        _monthViewAdapter.setOnDaySelectedListener(new MonthViewAdapter.OnDaySelectedListener() {
            ...
            public void onDaySelected(MonthViewAdapter view, int selectedMonth) {
                ...
                if (_monthNamesArrayResId != -1)
                    _month.setText(_context.getResources().getStringArray(_monthNamesArrayResId)[selectedMonth]);
                else
                    _month.setText(DateHelper.getMonthName(selectedMonth, _titleMonthFormat, _locale ));
    ...
    protected void setMonthFormat(String format) {
        _monthViewAdapter.setMonthFormat(format);
    }

    protected void setMonthTitleFormat(String format) {
        _titleMonthFormat = format;
    }

    protected void setMonthNamesArray(int resArrayId) {
