...
public class MonthPickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener {
    ...
    private void setLocale(Locale locale) {
        _monthPicker.setLocale(locale);
    }

    private void setMonthFormat(String format) {
        _monthPicker.setMonthFormat(format);
    }

    private void setMonthTitleFormat(String format) {
        _monthPicker.setMonthTitleFormat(format);
    }

    private void setMonthNamesArray(int resArrayId) {
        _monthPicker.setMonthNamesArray(resArrayId);
    }

    public void setMonthSelectedCircleSize(int size) {
    ...
    public static class Builder {
        ...
        private int _monthNamesArrayResId = -1;
         ...
         * @return Builder
         */
        public Builder setMonthFormat(String format) {
         ...
         * @return Builder
         */
        public Builder setMonthTitleFormat(String format) {
         ...
         * @return Builder
         */
        public Builder setMonthNamesArray(int arrayResId) {
            this._monthNamesArrayResId = arrayResId;
            return this;
        }

        public Builder setMonthSelectedCircleSize(int size) {
        ...
        public MonthPickerDialog build() {
            ...
            if (_locale != null)
                monthPickerDialog.setLocale(_locale);

            if (_monthNamesArrayResId != -1)
                monthPickerDialog.setMonthNamesArray(_monthNamesArrayResId);
